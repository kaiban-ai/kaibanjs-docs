...
- **Enum Defined At:** [Agent Status Definitions](https://github.com/AI-Champions/AgenticJS/blob/main/src/utils/enums.js#L1)
...
## Conclusion
Agents are the building blocks of the AgenticJS framework. By understanding how to define and interact with agents, you can create sophisticated AI systems that leverage the power of collaborative intelligence.
